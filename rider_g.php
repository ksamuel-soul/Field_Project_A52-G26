...
<body>
    ...
    <header>
      ...
      <ul>
            <b><p id="status" style="font-size:20px; color:white; padding-right:15px;"></p></b>
                ...
                <li><a href="account.php">My Account</a></li>
                <li><a href="myrides_g.php">My_Rides</a></li>
                <li><a href="logout.php">LogOut</a></li>
            </ul>
      </nav>
    </header>
    ...
    <main>
        ...
        echo "
            <form id='riderForm' action='rider_g.php' method='POST' enctype='multipart/form-data' onsubmit='return formValidation()' name='myForm'>
                ...
                <input type='text' id='driverName' name='driverName' value = '$uname'>
...
if(isset($_POST['submit']))
{
    ...
    {
        $query = "INSERT INTO rider (`Username`, `Source`, `Destination`, `Date`, `Time`, `Vehicle_Name`, `Driver_Name`, `Car_Num`, `Seat_Status`, `Price`) VALUES ('$email', '$source', '$dest', '$date', '$time', '$vehicle_name', '$driver_name', '$car_num', '$seat_cap', '$price')";
