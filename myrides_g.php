...
<?php
            ...
            $query = "SELECT * FROM rider WHERE Username = '$email' && Status = 'Dri_AP'";
            ...
            $qqeeuu = "SELECT * FROM rider WHERE Status = 'Live' && Username = '$email'";
...

            {
                ...
                {
                    $query = "UPDATE rider SET Status = 'Live' WHERE Username = '$email' && Status = 'Dri_AP'";

                    $data = mysqli_query($conn, $query);

                    // echo "<script>window.location.href = 'seeker.php';</script>";

                    echo "<script>window.location.href = 'myrides_g.php';</script>";
...
<?php
           ...
           $email = $_SESSION['uemail'];
            ...
            $query = "SELECT * FROM rider WHERE Username = '$email' && Status = 'Live'";
...

            {
                ...
                $mnm = "UPDATE rider SET Status = 'Ride_Completed' WHERE Username = '$email' && Status = 'Live'";
...
<?php
            ...
            $query = "SELECT * FROM rider WHERE Username = '$email' && Status = 'Ride_Completed'";
