...
<body>
    ...
    <main>
        ...
        <div class="auth-container">
            ...
            <form id="searchForm" method="POST" action="seeker_g.php">
        ...
        <div class="auth-containerar">
            ...
            <div id="allRides" class="ride-container">
                ...
                {    
                    ...
                    $query = "UPDATE rider SET S_Username = '$email', Status = 'P_Pending' WHERE R_Id = '$rrii'";
        ...
        <div class="auth-containerbr">
            ...
            <?php
                ...
                $query = "SELECT * FROM rider WHERE S_Username = '$email' && Status = 'Ride_Completed'";
                ...
                <?php
...

                    {
                            ...
                            echo " <tr>
                                    ...
                                    <form method='POST' action = 'seeker_g.php'>
...

                {
                    ...
                    $q = "SELECT * FROM rider WHERE S_Username = '$email' && R_Id = '$rri'";
...

                    {
                        ...
                        echo "<script>window.location.href = 'seeker_g.php';</script>";
